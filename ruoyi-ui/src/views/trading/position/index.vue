  ...
  <div class="app-container">
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <span>{{ $t('module.trading.position.title') }}</span>
      ...
      <el-form :inline="true" :model="queryParams" size="small">
        <el-form-item :label="$t('field.symbol')">
          <el-input v-model="queryParams.symbol" :placeholder="$t('placeholder.symbol')" clearable />
        </el-form-item>
        <el-form-item>
          <el-button type="primary" icon="el-icon-search" @click="handleQuery">{{ $t('button.search') }}</el-button>
          <el-button icon="el-icon-refresh" @click="resetQuery">{{ $t('button.reset') }}</el-button>
        </el-form-item>
      </el-form>
      ...
      <el-table v-loading="loading" :data="positionList" border>
        ...
        <el-table-column :label="$t('field.avgPrice')" align="center" prop="avgPrice" />
        <el-table-column :label="$t('field.currentPrice')" align="center" prop="currentPrice" />
        <el-table-column label="市值" align="center" prop="marketValue" />
        <el-table-column :label="$t('field.unrealizedPnl')" align="center" prop="unrealizedPnl">
        ...
        <el-table-column :label="$t('field.pnlRatio')" align="center" prop="unrealizedPnlRatio">
          <template slot-scope="scope">
